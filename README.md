...
| [Conversation catalog](extensions/conversation-catalog/README.md) | Natively browses and locally rereads saved conversations, then generates redaction-reviewed, evidence-cited hindsight reports. | [Install and use](extensions/conversation-catalog/README.md) |
