...
| [Conversation catalog](extensions/conversation-catalog/README.md) | Writes a standalone metadata catalog and opt-in historical conversation-flow HTML view with redaction review, export-decision metadata, and inspectable event citations. | [Install and use](extensions/conversation-catalog/README.md) |
